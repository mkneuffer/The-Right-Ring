...
export const QUESTIONS: Question[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'claw-prongs', name: 'Claw Prongs', subtitle: '(no additional cost)', imageUrl: '/images/AddedFeature/claw prongs.webp' },
            ...
            { id: 'filagree-cutouts', name: 'Filagree Cutouts', subtitle: '(no additional cost)', imageUrl: '/images/AddedFeature/Filagree cutouts.jpg' },
            ...
            { id: 'stone-higher', name: 'Stone Higher', subtitle: '(no additional cost)' },
            { id: 'stone-lower', name: 'Stone Lower', subtitle: '(no additional cost)' },
